...
local function set_osc_styles()
    ...
    osc_styles = {
        ...
        timecodes = "{\\blur0\\bord0\\1c&H" .. osc_color_convert(user_opts.timecode_color) .. "\\3c&HFFFFFF\\fs18\\fn" .. font_mono .. "}",
...
mp.set_key_bindings({
    ...
    {"mbtn_right_dbl",      function() process_event("mbtn_right_dbl", "press") end},
}, "input", "force")
