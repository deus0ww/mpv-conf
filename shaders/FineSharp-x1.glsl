...
//!BIND HOOKED
//!COMPONENTS 2
//!DESC FineSharp 1 Convolution x1_04
...
#define sstr 0.4    // Strength of sharpening, 0.0 up to 8.0 or more. If you change this, then alter cstr below
...
#define cstr 0.08   // Strength of equalisation, 0.0 to 2.0 or more. Suggested settings for cstr based on sstr value: 
