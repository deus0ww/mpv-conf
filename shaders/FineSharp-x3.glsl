...
//!BIND HOOKED
//!COMPONENTS 2
//!DESC FineSharp 1 Convolution x3_12
...
//!HOOK LUMA
//!BIND HOOKED
//!DESC FineSharp 2 Sharpening

#define sstr 1.2    // Strength of sharpening, 0.0 up to 8.0 or more. If you change this, then alter cstr below
...
//!BIND HOOKED
//!COMPONENTS 1
//!DESC FineSharp 3 Equalization

#define cstr 0.70   // Strength of equalisation, 0.0 to 2.0 or more. Suggested settings for cstr based on sstr value: 
